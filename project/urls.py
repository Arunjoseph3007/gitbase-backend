...
from .views import AdminProjectsCreateView,AdminProjectsUpdateView,UserProjectsListView,UserProjectDetailView,AdminProvideProjectAccess,AdminRemoveProjectAccess
urlpatterns = [
